            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
                    ...
                    <div className="md:col-span-2">
                        <div className="flex items-center gap-2 mb-4">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[var(--primary)] to-[var(--accent)] flex items-center justify-center text-white font-bold text-lg">
                                MG
                            </div>
                        ...
                        <p className="text-[var(--foreground-secondary)] max-w-md mb-6">
                            Senior AI/ML Engineer with 6+ years of experience building production-grade
                            machine learning systems. Passionate about solving complex problems with data.
                        </p>
                        <div className="flex gap-4">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    className="w-10 h-10 rounded-full bg-[var(--background-tertiary)] flex items-center justify-center text-[var(--foreground-secondary)] hover:text-[var(--primary)] hover:bg-[var(--background)] transition-colors"
                ...
                <div className="mt-12 pt-8 border-t border-[var(--border)] flex flex-col sm:flex-row justify-between items-center gap-4">
                    <p className="text-[var(--foreground-muted)] text-sm">
                        © {new Date().getFullYear()} Madhu Goutham Reddy Ambati. All rights reserved.
                    </p>
                    <p className="text-[var(--foreground-muted)] text-sm">
